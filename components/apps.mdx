...
Part of EnSync's hybrid encryption system. This public key is used to encrypt messages that only the intended recipient can decrypt. When your app receives encrypted messages, it uses the corresponding private key to decrypt them.

The public key can be safely shared and is used by other systems to encrypt messages destined for your app.

### Decrypt Key (Private Key)

The private half of the encryption key pair. This key is used to decrypt messages that were encrypted with your app's public key.
